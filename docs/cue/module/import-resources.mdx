---
title: "Import Kubernetes Resources from YAML"
sidebarTitle: "Import resources from YAML"
description: "Convert existing Kubernetes YAML manifests to CUE templates."
---

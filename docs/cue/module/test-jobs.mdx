---
title: "Run tests with Kubernetes Jobs"
description: "Write end-to-end tests as Kubernetes Jobs run by Timoni after deployment."
---
...
We set the [force annotation](/cue/module/apply-behavior#force-apply) on the Job's metadata to instruct

---
title: "Get Started with Timoni Modules"
sidebarTitle: "Get started with modules"
description: "Create a new module and learn its structure and development workflow."
---
...
The `config.cue` file contains a [schema definition](/cue/walkthrough#schema-definitions)
...
required or optional, if it has a [default value](/cue/walkthrough#default-values),
and which [validation rules](/cue/walkthrough#field-constraints) should be applied.
...
[CUE definitions](/cue/walkthrough#schema-definitions)

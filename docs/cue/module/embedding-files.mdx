...
description: "Embed configs, scripts and other plain files in modules with the @embed attribute."
---
...
Combined with the [`#ImmutableConfig` generator](/cue/module/immutable-config), any change to the

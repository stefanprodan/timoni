    ...
    <div className="mx-auto max-w-6xl px-6 py-16">
      ...
      <div className="mt-10">
        <CardGroup cols={3}>
          ...
          <Card title="Kubernetes CRD support" icon="gear" href="/cue/module/custom-resources">
  ...
  <section className="tm-band">
    <div className="mx-auto max-w-6xl px-6 py-16">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-3">
        <Card title="Coming from Helm?" icon="helmet-safety" href="/comparison">
    ...
    <div className="mx-auto max-w-6xl px-6 py-12">
      <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li><a href="https://github.com/stefanprodan/timoni">GitHub</a></li>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            ...
            <li><a href="https://x.com/stefanprodan">X</a></li>
            <li><a href="https://linkedin.com/in/stefanprodan">LinkedIn</a></li>
          </ul>
        </div>
      </div>

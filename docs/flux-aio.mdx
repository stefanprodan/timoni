---
title: "Flux AIO Distribution"
description: "A lightweight Flux CD distribution packaged as a Timoni module."
---
...
see the [Helm interoperability guide](/flux-helm-interop).
</Tip>
...
the flux-aio module and a [Bundle file](/bundle)
...
<Tabs sync={false}>
  ...
  <Tab title="Self-hosted repository">

---
title: "GitOps Guide"
sidebarTitle: "GitOps with Flux"
description: "Build a GitOps delivery pipeline for module instances with Timoni and Flux."
---
...
using the [flux-oci-sync module](/flux-aio#flux-oci-sync-configuration).
</Info>

...
sidebarTitle: "Multi-cluster deployments"
description: "Deliver applications across clusters and environments with bundles and runtimes."
---

Timoni offers a declarative way of managing the delivery of applications across environments.
The Timoni [Runtime](/bundle-runtime) allows defining groups of clusters where apps are being deployed.
The Timoni [Bundle](/bundle) supports customising the apps configuration based on the target
...
on how to query a cluster, please see the [runtime values doc](/bundle-runtime#values).

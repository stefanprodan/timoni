---
title: "timoni artifact"
description: "Commands for managing Open Container Initiative (OCI) artifacts"
mode: "wide"
---
...
* [timoni artifact build](/cmd/timoni_artifact_build)	 - Build an OCI artifact on the local filesystem
* [timoni artifact digest](/cmd/timoni_artifact_digest)	 - Resolve the digest of an artifact
* [timoni artifact list](/cmd/timoni_artifact_list)	 - List the tags of an artifact
* [timoni artifact pull](/cmd/timoni_artifact_pull)	 - Pull an artifact from a container registry
* [timoni artifact push](/cmd/timoni_artifact_push)	 - Push a directory contents to a container registry
* [timoni artifact tag](/cmd/timoni_artifact_tag)	 - Tag an OCI artifact in the upstream registry

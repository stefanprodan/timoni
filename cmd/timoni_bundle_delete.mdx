---
title: "timoni bundle delete"
description: "Delete all instances from a bundle"
mode: "wide"
---

## Synopsis

The bundle delete command uninstalls the instances and
...
```
timoni bundle delete [flags]
```

## Examples

```sh
  # Uninstall all instances in a bundle

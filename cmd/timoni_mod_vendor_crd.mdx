---
title: "timoni mod vendor crd"
description: "Vendor Kubernetes CRD CUE schemas"
mode: "wide"
---

```
timoni mod vendor crd [MODULE PATH] [flags]
```

## Examples

```sh
  # Vendor CUE schemas generated from Kubernetes CRDs included in a local YAML file
...
```
  -f, --file string   The path to Kubernetes CRD YAML.
  -h, --help          help for crd
```

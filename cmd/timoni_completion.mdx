...
* [timoni completion bash](/cmd/timoni_completion_bash)	 - Generates bash completion scripts
* [timoni completion fish](/cmd/timoni_completion_fish)	 - Generates fish completion scripts
* [timoni completion powershell](/cmd/timoni_completion_powershell)	 - Generates powershell completion scripts
* [timoni completion zsh](/cmd/timoni_completion_zsh)	 - Generates zsh completion scripts

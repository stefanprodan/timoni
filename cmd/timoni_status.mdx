---
title: "timoni status"
description: "Displays the current status of Kubernetes resources managed by an instance"
mode: "wide"
---

```
timoni status INSTANCE_NAME [flags]
```

## Examples

```sh
  # Show the current status of the managed resources

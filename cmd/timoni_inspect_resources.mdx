---
title: "timoni inspect resources"
description: "Print the Kubernetes objects managed by an instance"
mode: "wide"
---

```
timoni inspect resources INSTANCE_NAME [flags]
```

## Examples

```sh
  # Print the managed resources

---
title: "timoni artifact build"
description: "Build an OCI artifact on the local filesystem"
mode: "wide"
---

```
timoni artifact build [flags]
```
...
```
  ...
  -f, --filepath string          Path to a local file or directory. (default ".")
  ...
  -t, --tag stringArray          Local descriptor reference name.
```

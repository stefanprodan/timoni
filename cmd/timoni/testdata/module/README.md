...
| `client: image: reference:`                         | `string` | `"cgr.dev/chainguard/timoni:latest-dev@sha256:b49fbaac0eedc22c1cfcd26684707179cccbed0df205171bae3e1bae61326a10"` | Reference is the image address computed from repository, tag and digest in the format [REPOSITORY]:[TAG]@[DIGEST].                                                                                                                            |

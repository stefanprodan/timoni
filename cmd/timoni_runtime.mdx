---
title: "timoni runtime"
description: "Commands for managing runtimes"
mode: "wide"
---
...
* [timoni runtime build](/cmd/timoni_runtime_build)	 - Build validates the runtime definition, queries the cluster, extracts the values and prints them

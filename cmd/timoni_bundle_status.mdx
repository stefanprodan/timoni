---
title: "timoni bundle status"
description: "Displays the current status of Kubernetes resources managed by the bundle instances"
mode: "wide"
---

```
timoni bundle status [BUNDLE NAME] [flags]
```

## Examples

```sh
  # Show the status of the resources managed by a bundle

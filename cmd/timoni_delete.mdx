---
title: "timoni delete"
description: "Uninstall a module instance from the cluster"
mode: "wide"
---

## Synopsis

The delete command uninstalls the instance and deletes all its
...
```
timoni delete INSTANCE_NAME [flags]
```

...
| `pod: securityContext:`  | `corev1.#PodSecurityContext`     | `<generated>`                           | [Kubernetes pod security context](https://kubernetes.io/docs/tasks/configure-pod-container/security-context), generated from `securityProfile` |
...
| `securityProfile:`       | `"hardened" \| "platform"`       | `hardened`                              | `hardened` pins the image's UID/GID, `platform` leaves them to be assigned by an admission controller (e.g. OpenShift)                         |

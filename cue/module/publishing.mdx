---
title: "Module Publishing"
sidebarTitle: "Publishing module versions"
description: "Version and publish modules as OCI artifacts."
---
...
[timoni mod build](/cmd/timoni_mod_build) writes the same ordered
...
When publishing a module with [timoni mod push](/cmd/timoni_mod_push),
...
please the [timoni mod push docs](/cmd/timoni_mod_push).
...
To automate the publishing of module versions, please see the [Timoni GitHub Actions doc](/cue/module/github-actions).
